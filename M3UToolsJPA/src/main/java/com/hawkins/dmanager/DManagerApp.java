...
import com.hawkins.m3Utoolsjpa.downloaders.DashDownloader;
import com.hawkins.m3Utoolsjpa.downloaders.Downloader;
import com.hawkins.m3Utoolsjpa.downloaders.HdsDownloader;
import com.hawkins.m3Utoolsjpa.downloaders.HlsDownloader;
import com.hawkins.m3Utoolsjpa.downloaders.HttpDownloader;
...
public class DManagerApp implements DownloadListener, Comparator<String> {
	...
	public void cancelDownload(String id) {
		...
		if (downloader != null) {
			DownloadEntry de = downloads.get(id);
			if (de != null) {
				de.setState(DManagerConstants.CANCELLED);
			}
			downloader.stop();
			downloader.sendProgress(id, de, this.template);
			downloader.unregisterListener();
