...
import com.hawkins.m3utoolsjpa.M3UToolsJpaApplication;
...
public class DManagerUtils {
	...
	public static File getJarFile() {
		try {
			return new File(M3UToolsJpaApplication.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath());
