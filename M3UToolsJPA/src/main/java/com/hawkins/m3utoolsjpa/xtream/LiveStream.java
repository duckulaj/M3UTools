...
public class LiveStream {
    ...
    public int getTv_archive_duration() { return tv_archive_duration; }
    public void setTv_archive_duration(int tv_archive_duration) { this.tv_archive_duration = tv_archive_duration; }
}
