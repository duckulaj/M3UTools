package com.hawkins.M3UToolsJPA.network.http;
...
import com.hawkins.M3UToolsJPA.network.ICredentialManager;
...
public class HttpContext {
	...
	public void init() {
		if (!init) {
			 ...
			 * System.out.println("Called on " + getRequestorType() + " scheme: " +
			 * getRequestingScheme() + " host: " + getRequestingHost() + " url: " +
			 * getRequestingURL() + " prompt: " + getRequestingPrompt()); if
			 * (getRequestorType() == RequestorType.SERVER) {
			 * 
			 * PasswordAuthentication pauth = CredentialManager.getInstance()
			 * .getCredentialForHost(getRequestingHost()); return pauth; } else { return
			 * CredentialManager.getInstance().getCredentialForProxy(); } // return new //
